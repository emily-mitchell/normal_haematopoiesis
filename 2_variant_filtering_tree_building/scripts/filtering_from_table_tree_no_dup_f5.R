#Inital filtering script with samples that have failed QC removed (depth < 7X and peak VAF < 0.4)
#This script is submitted to the Sanger farm 
#Filtering of variant calls and tree building using mpboot
#Assignment of mutations to tree with ancestral branch removed
#Variant annotation using Vagrent
#Output from this script is used for final downstream subs and tree building analysis 
#This output is available on Mendeley Data for all individuals 

#ensure working directory correct at 2 points in script

#Author: Mike Spencer Chapman (adapted by Emily Mitchell)
