#Inital filtering script run with all samples and variants retained
...
#Output from this script is used to perform QC on samples using the script KX001_4_subs_analysis.Rmd
