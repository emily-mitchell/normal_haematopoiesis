...
tree_path = paste0("/lustre/scratch117/casm/team154/em16/",ID,"/",Iteration,"/trees_vaf_cut/tree_",Run_ID,"_standard_rho01_final.tree")
#details_path = paste0()
